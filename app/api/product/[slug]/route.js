...
export async function GET(req, { params }) {
  try {
    ...
    if (allItem.length === 0) {
      return NextResponse.json({ success: false, status: 404, message: "No items found" }, { status: 404, headers: { "Content-Type": "application/json" } });
    }

    return NextResponse.json({ status: 200, success: true, data: allItem }, { status: 200, headers: { "Content-Type": "application/json" } });
  } catch (error) {
